...
, unemployment at `https://www.bls.gov/guide/geography/employment.htm`, and New York Times Covid at `https://www.nytimes.com/interactive/2020/us/coronavirus-us-cases.html`. To use these with the code from the github, these datasets need to be converted to .csv files.
